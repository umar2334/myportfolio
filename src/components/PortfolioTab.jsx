...
const projects = [
  ...
  },
  {
    ...
    title: 'SEO Autopilot',
    subtitle: 'AI Content Distribution SaaS — auto-publish & SEO.',
    tech: 'Next.js · AI · OAuth · SaaS',
    badges: [
    ...
    stats: [
      ...
      { value: 'AI', label: 'Rewrites' },
    ],
    btnColor: '#06b6d4',
    demo: 'https://seo-autopilot-five.vercel.app/',
    github: null,
    isDownload: false,
    img: '/seo.png',
    desc: 'AI-powered marketing automation SaaS that distributes blog content across Medium, Dev.to, LinkedIn, Hashnode, Reddit & Tumblr. Auto-rewrites articles per platform, schedules across 48hr windows, and tracks rankings — built for indie hackers scaling SEO.',
    features: ['Multi-Platform Auto Publishing', 'AI Article Rewriter', 'Humanized Scheduling', 'Real-Time SEO Analytics'],
  },
  {
    id: 'p7',
    ...
    subtitle: 'AI Lead Generation SaaS + Chrome Extension.',
    tech: 'Next.js · Gemini AI · Chrome Extension',
    badges: [
    ...
    stats: [
      { value: '50+', label: 'Leads/Scan' },
      { value: 'Gemini', label: 'AI Powered' },
      { value: 'SaaS', label: 'Dashboard' },
    ],
    btnColor: '#6366f1',
    demo: 'https://leadhunter-pro-pied.vercel.app',
    github: 'https://github.com/umar2334/leadhunter-pro',
    isDownload: false,
    img: '/leadhunter.png',
    desc: 'A Chrome Extension + Next.js SaaS that auto-scans Google Maps and generates AI-powered outreach messages via Gemini AI. Turns Google Maps into a full outreach pipeline — 50+ qualified leads per scan.',
  ...
  },
  {
    ...
    title: 'TurkVerse',
    subtitle: 'Turkish Drama Portal — High-Traffic Media Platform.',
    tech: 'Next.js · SEO · SSR/SSG',
    badges: [
    ...
    stats: [
      { value: '12+', label: 'Users/24hrs' },
      { value: 'SSR', label: 'Architecture' },
      { value: 'Live', label: 'Production' },
    ],
    btnColor: '#8b5cf6',
    demo: 'https://www.turkdrama.live',
    github: null,
    isDownload: false,
    img: '/turkverse.png',
    desc: 'A high-performance blog and news portal dedicated to Turkish dramas. Built with Next.js SSR/SSG, real-time SEO strategies, and optimized image delivery. Scaled to 12+ active users within 24 hours of launch.',
